...
public class BungeeCord extends ProxyServer
{
    ...
    public final Gson gson = new GsonBuilder()
            ...
            .registerTypeAdapter( ServerPing.PlayerInfo.class, new LegacyPlayerInfoSerializer( ProtocolConstants.MINECRAFT_1_7_6 ) )
    ...
    public final Gson gsonLegacy = new GsonBuilder()
            ...
            .registerTypeAdapter( ScoreComponent.class, new ScoreComponentSerializer() )
            .registerTypeAdapter( SelectorComponent.class, new SelectorComponentSerializer() )
            .registerTypeAdapter( ServerPing.PlayerInfo.class, new LegacyPlayerInfoSerializer( ProtocolConstants.MINECRAFT_1_7_2 ) )
            .registerTypeAdapter( Favicon.class, Favicon.getFaviconTypeAdapter() ).create();
    @Getter
